...
abstract class RustLibApi extends BaseApi {
  ...
  Future<UITags> tags({dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> appendDownload(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kAppendDownloadConstMeta,
      argValues: [data],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kAppendDownloadConstMeta => const TaskConstMeta(
  ...
  Future<UICacheImage> cacheImage(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCacheImageConstMeta,
      argValues: [
        cacheKey,
        url,
        useful,
  ...
  TaskConstMeta get kCacheImageConstMeta => const TaskConstMeta(
  ...
  Future<void> cleanCache({required int time, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCleanCacheConstMeta,
      argValues: [time],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCleanCacheConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kCollectFromAccountConstMeta => const TaskConstMeta(
  ...
  Future<void> collectToAccount(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCollectToAccountConstMeta,
  ...
  TaskConstMeta get kCollectToAccountConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kComicConstMeta => const TaskConstMeta(
        debugName: "comic",
        argNames: ["pathWord"],
      );
  ...
  Future<UIChapterData> comicChapterData(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kComicChapterDataConstMeta,
  ...
  TaskConstMeta get kComicChapterDataConstMeta => const TaskConstMeta(
  ...
  Future<UIPageComicChapter> comicChapters(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kComicChaptersConstMeta,
  ...
  TaskConstMeta get kComicChaptersConstMeta => const TaskConstMeta(
  ...
  Future<UIComicQuery> comicQuery({required String pathWord, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kComicQueryConstMeta,
      argValues: [pathWord],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kComicQueryConstMeta => const TaskConstMeta(
  ...
  Future<UIPageUIComicInList> comicSearch(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kComicSearchConstMeta,
  ...
  TaskConstMeta get kComicSearchConstMeta => const TaskConstMeta(
  ...
  Future<void> deleteDownloadComic(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDeleteDownloadComicConstMeta,
  ...
  TaskConstMeta get kDeleteDownloadComicConstMeta => const TaskConstMeta(
  ...
  Future<List<UIDownloadComicChapter>> downloadComicChapters(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDownloadComicChaptersConstMeta,
      argValues: [comicPathWord],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDownloadComicChaptersConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kDownloadComicGroupsConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kDownloadComicPagesConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kDownloadComicsConstMeta => const TaskConstMeta(
  ...
  Future<bool> downloadIsPause({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDownloadIsPauseConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDownloadIsPauseConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kDownloadSetPauseConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kExplorerConstMeta => const TaskConstMeta(
        debugName: "explorer",
  ...
  TaskConstMeta get kExportsConstMeta => const TaskConstMeta(
        debugName: "exports",
        argNames: ["uuidList", "exportToFolder", "exportsType"],
      );

  @override
  Future<UIViewLog?> findComicViewLog(
      {required String pathWord, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(pathWord, serializer);
      ...
      constMeta: kFindComicViewLogConstMeta,
      argValues: [pathWord],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kFindComicViewLogConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kGetProxyConstMeta => const TaskConstMeta(
        debugName: "get_proxy",
        argNames: [],
      );
  ...
  TaskConstMeta get kHttpGetConstMeta => const TaskConstMeta(
        debugName: "http_get",
        argNames: ["url"],
      );
  ...
  Future<List<String>> inDownloadChapterUuid(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kInDownloadChapterUuidConstMeta,
      argValues: [comicPathWord],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kInDownloadChapterUuidConstMeta => const TaskConstMeta(
  ...
  Future<UILoginState> initLoginState({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kInitLoginStateConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kInitLoginStateConstMeta => const TaskConstMeta(
  ...
  Future<UIPageUIViewLog> listComicViewLogs(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kListComicViewLogsConstMeta,
  ...
  TaskConstMeta get kListComicViewLogsConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kLoadPropertyConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kRankConstMeta => const TaskConstMeta(
        debugName: "rank",
  ...
  Future<UIPageUIComicInList> recommends(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kRecommendsConstMeta,
      argValues: [offset, limit],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kRecommendsConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kRegisterConstMeta => const TaskConstMeta(
        debugName: "register",
        argNames: ["username", "password"],
      );
  ...
  Future<void> resetFailDownloads({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kResetFailDownloadsConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kResetFailDownloadsConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kSavePropertyConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kSetProxyConstMeta => const TaskConstMeta(
        debugName: "set_proxy",
        argNames: ["proxy"],
      );
  ...
  TaskConstMeta get kTagsConstMeta => const TaskConstMeta(
        debugName: "tags",
        argNames: [],
      );
  ...
  Future<void> viewChapterPage(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kViewChapterPageConstMeta,
      argValues: [
        comicPathWord,
        chapterUuid,
        chapterName,
  ...
  TaskConstMeta get kViewChapterPageConstMeta => const TaskConstMeta(
  ...
  Future<void> viewComicInfo(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kViewComicInfoConstMeta,
  ...
  TaskConstMeta get kViewComicInfoConstMeta => const TaskConstMeta(
